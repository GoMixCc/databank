...
*	[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix): streaming torrent client for golang
*	[node-torrent-cloud](https://github.com/jpillora/node-torrent-cloud): Torrent Cloud – A self-hosted Bittorrent client in the Cloud
